...
public class Tower1Shooting : MonoBehaviour
{
    ...
    void SpawnBullet()
    {
        ...
        {
            GameObject tempBullet = Instantiate(Tbullet, bulletSpawn[i].transform.position, Quaternion.Euler(bulletSpawn[i].transform.forward)) as GameObject;
