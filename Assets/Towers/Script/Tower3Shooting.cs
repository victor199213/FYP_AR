...
public class Tower3Shooting : MonoBehaviour
{
    ...
    void SpawnBullet()
    {
        ...
        {
            GameObject tempBullet = Instantiate(poisonBullet, bulletSpawn[i].transform.position, Quaternion.Euler(bulletSpawn[i].transform.forward)) as GameObject;
